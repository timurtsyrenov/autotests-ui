...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self._estimated_time_input = page.get_by_test_id("create-course-form-estimated-time-input").locator("input")
    ...
    def fill(self, title: str, estimated_time: str, description: str, max_score: str, min_score: str):
        ...
        self._estimated_time_input.fill(estimated_time)
        expect(self._estimated_time_input).to_have_value(estimated_time)
    ...
    def check_visible(self, title: str, estimated_time: str, description: str, max_score: str, min_score: str):
        ...
        expect(self._estimated_time_input).to_be_visible()
        expect(self._estimated_time_input).to_have_value(estimated_time)
